...
include "D:\Wamp\wamp\www\BlogProject\libs\my_ul.en.php";
include "D:\Wamp\wamp\www\BlogProject\libs\my_ul.uk.php";
...
if(isset($_POST['read'])){
  ...
  header("Location: sepItem_ul.php");
}
 ...
 $smarty -> display("newsFile_ul.tpl");
